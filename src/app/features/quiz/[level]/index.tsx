...
const QUIZ_DATA: Record<string, { title: string; items: string[] }> = {
  "lv-1": {
    title: "초급 퀴즈 리스트",
    items: ["주식이란?", "시가총액", "지수는 어떻게 만들어질까?", "지수의 종류 1편", "지수의 종류 2편", "채권이란?", "투자 위험", "증권사 선택", "주식계좌 개설", "HTS와 MTS", "호가창의 이해", "주식 주문 종류", "주식시장 거래 시간", "배당금이란?", "배당락과 결제일 배당 기준일", "보통주 vs 우선주"],
  },
  "lv-2": {
    title: "중급 퀴즈 리스트",
    items: ["분산투자", "대출 투자", "경제신문 활용법", "ETF", "환율과 증시", "금리 변동", "기준금리란?", "IPO", "증자와 감자", "공매도", "자사주 소각", "네마녀의 날"],
  },
  "lv-3": {
    title: "고급 퀴즈 리스트",
    items: ["재무제표란?", "매출 vs 영업이익", "어닝 시즌", "부채비율", "저평가 주식 찾기", "BPS와 PBR", "EPS와 PER", "ROE", "EV/EBITDA", "거래량 분석", "기술적 분석", "지지선과 저항선", "이동평균선", "골든크로스 vs 데드크로스", "스토캐스틱", "RSI", "볼린저밴드"],
  },
};
